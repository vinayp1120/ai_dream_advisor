      ...
      <div className="pt-16 p-4">
        <div className="max-w-4xl mx-auto py-16">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Manage your DreamAdvisor account and subscription</p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-gray-200 shadow-xl">
                ...
                <div className="space-y-3">
                  <button
                    onClick={() => onBack()}
                    className="w-full text-left p-4 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors"
                  >
                    <div className="font-medium text-blue-900">Submit New Idea</div>
                    <div className="text-sm text-blue-700">Get AI therapy for your latest startup concept</div>
                  </button>
                  ...
                  <button
                    ...
                    className="w-full text-left p-4 bg-yellow-50 rounded-xl hover:bg-yellow-100 transition-colors"
                  >
                    <div className="font-medium text-yellow-900">View Leaderboard</div>
                    <div className="text-sm text-yellow-700">See how your ideas rank against others</div>
                  </button>
                </div>
              </div>
            </div>
