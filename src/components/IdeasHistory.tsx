...
import { ArrowLeft, Calendar, MessageSquare, Mic, Star, TrendingUp, Eye, Archive, Loader, Brain, Sparkles, Lightbulb } from 'lucide-react';
          ...
          {filteredIdeas.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                {filter === 'all' ? 'Your Idea Journey Starts Here!' : `No ${filter} ideas yet`}
              </h3>
              <p className="text-lg text-gray-600 mb-8 max-w-md mx-auto">
                {filter === 'all' 
                  ? 'Ready to turn your wild ideas into gold? Submit your first startup idea and get AI-powered therapy feedback!'
                  : `You don't have any ${filter} ideas at the moment. Keep submitting ideas to build your entrepreneurial portfolio!`
                }
              </p>
              {filter === 'all' && (
                <button
                ...
                >
                  ...
                  <span>Submit Your First Genius Idea</span>
                </button>
              )}
            </div>
          ) : (
